...
class test_configuration(unittest.TestCase):    
    def setUp(self):
        self.maxDiff = None
        self.configuration = configuration("tests/fixtures/test_configuration.yaml", "tests/fixtures/test_validation.yaml")
    ...
    def test_configuration_attr(self):
        expected_post_process_configuration = {'blockchain': 'Ethereum', 'chain_id': 1, 'network_name': 'Mainnet', 'network_type': 'Mainnet', 'collector': 'evm', 'endpoints': [{'url': 'wss://test1.com', 'provider': 'TestProvider1', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1}, {'url': 'wss://test2.com', 'provider': 'TestProvider2', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1}, {'url': 'wss://test3.com', 'provider': 'TestProvider3', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1}]}
    ...
    def test_add_metadata_to_all_endpoints(self):
        ...
        expected_configuration = {'blockchain': 'Ethereum', 'chain_id': 1, 'network_name': 'Mainnet', 'network_type': 'Mainnet', 'collector': 'evm', 'endpoints': [{'url': 'wss://test1.com', 'provider': 'TestProvider1', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1, 'test_key': 'test_value'}, {'url': 'wss://test2.com', 'provider': 'TestProvider2', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1, 'test_key': 'test_value'}, {'url': 'wss://test3.com', 'provider': 'TestProvider3', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1, 'test_key': 'test_value'}]}
        self.assertEqual(self.configuration.configuration, expected_configuration)
        
    def test_endpoints_attr(self):
        expected_endpoints = [{'url': 'wss://test1.com', 'provider': 'TestProvider1', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1}, {'url': 'wss://test2.com', 'provider': 'TestProvider2', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1}, {'url': 'wss://test3.com', 'provider': 'TestProvider3', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1}]
    ...
    def test_isEvm_attr_notEvm(self):
        config = {'blockchain': 'Conflux', 'chain_id': 1, 'network_name': 'Mainnet', 'network_type': 'Mainnet', 'collector': 'conflux', 'endpoints': [{'url': 'wss://test1.com', 'provider': 'TestProvider1', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1}, {'url': 'wss://test2.com', 'provider': 'TestProvider2', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1}, {'url': 'wss://test3.com', 'provider': 'TestProvider3', 'blockchain': 'Ethereum', 'network_type': 'Mainnet', 'network_name': 'Mainnet', 'chain_id': 1}]}
